...
![](/documents/img/ops/linux/basic/jincheng/27.png)

7. 暂停：`Ctrl + Z`；查看后台：`jobs`；恢复前台：`fg %1`（%1 为 jobs 列表中的序号）；临时切换终端：`bg %1` 后直接输入命令；

![](/documents/img/ops/linux/basic/jincheng/28.png)
![](/documents/img/ops/linux/basic/jincheng/29.png)
...
![](/documents/img/ops/linux/basic/jincheng/30.png)
